...
const MovieListItem = ({ movies, path, onRemove }: Props) => {
    ...
    return (
        ...
        <Card style={{ width: '14rem'}} className="text-center my-2" border="secondary">
            <a href={toPath}>
                <Card.Img style={{ width: '13.8rem', height: '300px',}} variant="top" src={`${process.env.REACT_APP_API_BASE_URL}/img/${poster}`} />
            </a>
            <Card.Body>
                <Card.Title>
                    <div>
                ...
                <Card.Text className="text-center">
                    ...
                    <Button className="btn btnClass" variant="outline-danger" size="sm" hidden={isFavouritePage} onClick={addMovieToFavourite}>
                        Add to favourite
                        <FontAwesomeIcon icon={faHeart}
                            className="ms-2 fa-sm"
                            color="Red"
                        /></Button>
                    <Button className="btn btnClass" variant="outline-danger" size="sm" hidden={!isFavouritePage} onClick={removeMovieFromFavourite}>Remove from favourite
                        <FontAwesomeIcon icon={faHeart}
                            className="ms-2 fa-sm"
                            color="Grey"
                        /></Button>
